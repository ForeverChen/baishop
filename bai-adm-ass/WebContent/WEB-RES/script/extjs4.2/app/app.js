...
Ext.define("Docs.view.casass.Device", {
	config: {
		url: "",
		id: undefined,
		device: "phone",
...
Ext.define("Docs.view.casass.InlineToolbar", {
	extend: "Ext.toolbar.Toolbar",
	componentCls: "inline-casass-tb",
	height: 30,
	initComponent: function() {
...
Ext.define("Docs.view.casass.Container", {
	extend: "Ext.container.Container",
	alias: "widget.casasscontainer",
	layout: "fit",
	initComponent: function() {
...
Ext.define("Docs.view.casass.InlineEditor", {
	extend: "Ext.Panel",
	bodyPadding: 2,
	autoScroll: true,
	componentCls: "inline-casass-editor",
	initComponent: function() {
...
Ext.define("Docs.view.casass.InlinePreview", {
	extend: "Ext.Panel",
	requires: ["Docs.view.casass.Device"],
	bodyPadding: "0 10",
	statics: {
		iframeCounter: 0,
	...
	update: function(h) {
		...
		if (e) {
			e.on("load", function() {
				Ext.Function.defer(function() {
					e.dom.contentWindow.loadInlineCasass(h + "\n", f, g)
				}, 100)
			}, this, {
				single: true
			});
...
Ext.define("Docs.view.casass.Inline", {
	extend: "Ext.Panel",
	alias: "widget.inlinecasass",
	requires: ["Docs.view.casass.InlineEditor", "Docs.view.casass.InlinePreview"],
	componentCls: "inline-casass-cmp",
	layout: "card",
	border: 0,
	resizable: {
		transparent: true,
	...
	initComponent: function() {
		...
		this.items = [this.editor = Ext.create("Docs.view.casass.InlineEditor", {
			cmpName: "code",
			value: this.value,
			listeners: {
		...
		}), this.preview = Ext.create("Docs.view.casass.InlinePreview", {
			cmpName: "preview",
...
Ext.define("Docs.view.casass.InlineWrap", {
	requires: ["Docs.view.casass.Inline", "Docs.view.casass.InlineToolbar"],
	...
	initToolbar: function() {
		...
		this.tb = Ext.create("Docs.view.casass.InlineToolbar", {
			renderTo: b
		})
	},
	replacePre: function(d) {
		...
		Ext.create("Docs.view.casass.Inline", {
			height: 200,
			renderTo: c,
...
Ext.define("Docs.controller.InlineCasass", {
	extend: "Ext.app.Controller",
	requires: ["Docs.view.casass.InlineWrap"],
	init: function() {
		this.control({
			classoverview: {
				resize: this.createResizer(".class-overview"),
				afterload: this.replaceCasassDivs
			}
		})
	},
	createResizer: function(b) {
		return function() {
			Ext.Array.each(Ext.ComponentQuery.query(b + " .inlinecasass"), function(a) {
	...
	replaceCasassDivs: function() {
		Ext.Array.each(Ext.query(".inline-casass"), function(b) {
			Ext.create("Docs.view.casass.InlineWrap", b)
		}, this)
	}
});
...
Ext.define("Docs.view.shopmng.Device", {
	config: {
		url: "",
		id: undefined,
		device: "phone",
...
Ext.define("Docs.view.shopmng.InlineToolbar", {
	extend: "Ext.toolbar.Toolbar",
	componentCls: "inline-casass-tb",
	height: 30,
	initComponent: function() {
...
Ext.define("Docs.view.shopmng.Container", {
	extend: "Ext.container.Container",
	alias: "widget.shopmngcontainer",
	layout: "fit",
	initComponent: function() {
		this.tpl = new Ext.XTemplate('<iframe style="width: 100%; height: 100%; border: 0;" src="{url}"></iframe>');
		this.callParent(arguments)
...
Ext.define("Docs.view.shopmng.InlineEditor", {
	extend: "Ext.Panel",
	bodyPadding: 2,
	autoScroll: true,
	componentCls: "inline-casass-editor",
...
Ext.define("Docs.view.shopmng.InlinePreview", {
	extend: "Ext.Panel",
	requires: ["Docs.view.shopmng.Device"],
	bodyPadding: "0 10",
	statics: {
		iframeCounter: 0,
		getNextIframeId: function() {
	...
	update: function(h) {
		...
		if (e) {
			e.on("load", function() {
				Ext.Function.defer(function() {
					e.dom.contentWindow.loadInlineShopmng(h + "\n", f, g)
				}, 100)
			}, this, {
				single: true
			});
...
Ext.define("Docs.view.shopmng.Inline", {
	extend: "Ext.Panel",
	alias: "widget.inlineshopmng",
	requires: ["Docs.view.shopmng.InlineEditor", "Docs.view.shopmng.InlinePreview"],
	componentCls: "inline-casass-cmp",
	layout: "card",
	border: 0,
	resizable: {
	...
	initComponent: function() {
		...
		this.items = [this.editor = Ext.create("Docs.view.shopmng.InlineEditor", {
			cmpName: "code",
			value: this.value,
			listeners: {
				init: this.updateHeight,
		...
		}), this.preview = Ext.create("Docs.view.shopmng.InlinePreview", {
			cmpName: "preview",
			options: this.options
		})];
		this.relayEvents(this.preview, ["previewsuccess", "previewfailure"]);
...
Ext.define("Docs.view.shopmng.InlineWrap", {
	requires: ["Docs.view.shopmng.Inline", "Docs.view.shopmng.InlineToolbar"],
	constructor: function(c) {
		this.pre = c;
		var d = this.parseOptions(c.className);
		this.initToolbar();
	...
	initToolbar: function() {
		var b = document.createElement("div");
		this.pre.parentNode.insertBefore(b, this.pre);
		this.tb = Ext.create("Docs.view.shopmng.InlineToolbar", {
			renderTo: b
		})
	},
	replacePre: function(d) {
		var c = document.createElement("div");
		this.pre.parentNode.replaceChild(c, this.pre);
		Ext.create("Docs.view.shopmng.Inline", {
			height: 200,
			renderTo: c,
			value: Ext.String.htmlDecode(Ext.util.Format.stripTags(this.pre.innerHTML)),
			options: d,
...
Ext.define("Docs.controller.InlineShopmng", {
	extend: "Ext.app.Controller",
	requires: ["Docs.view.shopmng.InlineWrap"],
	init: function() {
		this.control({
			classoverview: {
				resize: this.createResizer(".class-overview"),
				afterload: this.replaceShopmngDivs
			}
		})
	},
	createResizer: function(b) {
	...
	replaceShopmngDivs: function() {
		Ext.Array.each(Ext.query(".inline-casass"), function(b) {
			Ext.create("Docs.view.shopmng.InlineWrap", b)
		}, this)
	}
});
...
Ext.define("Docs.view.erpcrm.Device", {
	config: {
		url: "",
		id: undefined,
		device: "phone",
...
Ext.define("Docs.view.erpcrm.InlineToolbar", {
	extend: "Ext.toolbar.Toolbar",
	componentCls: "inline-casass-tb",
	height: 30,
	initComponent: function() {
...
Ext.define("Docs.view.erpcrm.Container", {
	extend: "Ext.container.Container",
	alias: "widget.erpcrmcontainer",
	layout: "fit",
	initComponent: function() {
		this.tpl = new Ext.XTemplate('<iframe style="width: 100%; height: 100%; border: 0;" src="{url}"></iframe>');
		this.callParent(arguments)
...
Ext.define("Docs.view.erpcrm.InlineEditor", {
	extend: "Ext.Panel",
	bodyPadding: 2,
	autoScroll: true,
	componentCls: "inline-casass-editor",
...
Ext.define("Docs.view.erpcrm.InlinePreview", {
	extend: "Ext.Panel",
	requires: ["Docs.view.erpcrm.Device"],
	bodyPadding: "0 10",
	statics: {
		iframeCounter: 0,
		getNextIframeId: function() {
	...
	update: function(h) {
		...
		if (e) {
			e.on("load", function() {
				Ext.Function.defer(function() {
					e.dom.contentWindow.loadInlineErpcrm(h + "\n", f, g)
				}, 100)
			}, this, {
				single: true
			});
...
Ext.define("Docs.view.erpcrm.Inline", {
	extend: "Ext.Panel",
	alias: "widget.inlineerpcrm",
	requires: ["Docs.view.erpcrm.InlineEditor", "Docs.view.erpcrm.InlinePreview"],
	componentCls: "inline-casass-cmp",
	layout: "card",
	border: 0,
	resizable: {
	...
	initComponent: function() {
		...
		this.items = [this.editor = Ext.create("Docs.view.erpcrm.InlineEditor", {
			cmpName: "code",
			value: this.value,
			listeners: {
				init: this.updateHeight,
		...
		}), this.preview = Ext.create("Docs.view.erpcrm.InlinePreview", {
			cmpName: "preview",
			options: this.options
		})];
		this.relayEvents(this.preview, ["previewsuccess", "previewfailure"]);
...
Ext.define("Docs.view.erpcrm.InlineWrap", {
	requires: ["Docs.view.erpcrm.Inline", "Docs.view.erpcrm.InlineToolbar"],
	constructor: function(c) {
		this.pre = c;
		var d = this.parseOptions(c.className);
		this.initToolbar();
	...
	initToolbar: function() {
		var b = document.createElement("div");
		this.pre.parentNode.insertBefore(b, this.pre);
		this.tb = Ext.create("Docs.view.erpcrm.InlineToolbar", {
			renderTo: b
		})
	},
	replacePre: function(d) {
		var c = document.createElement("div");
		this.pre.parentNode.replaceChild(c, this.pre);
		Ext.create("Docs.view.erpcrm.Inline", {
			height: 200,
			renderTo: c,
			value: Ext.String.htmlDecode(Ext.util.Format.stripTags(this.pre.innerHTML)),
			options: d,
...
Ext.define("Docs.controller.InlineErpcrm", {
	extend: "Ext.app.Controller",
	requires: ["Docs.view.erpcrm.InlineWrap"],
	init: function() {
		this.control({
			classoverview: {
				resize: this.createResizer(".class-overview"),
				afterload: this.replaceErpcrmDivs
			}
		})
	},
	createResizer: function(b) {
	...
	replaceErpcrmDivs: function() {
		Ext.Array.each(Ext.query(".inline-casass"), function(b) {
			Ext.create("Docs.view.erpcrm.InlineWrap", b)
		}, this)
	}
});
...
Ext.define("Docs.view.cls.Overview", {
	...
	requires: ["Docs.view.cls.Toolbar", "Docs.view.casass.Inline", "Docs.view.shopmng.Inline", "Docs.view.erpcrm.Inline", "Docs.view.cls.MemberWrap", "Docs.Syntax", "Docs.Settings"],
	mixins: ["Docs.view.Scrolling"],
...
Ext.define("Docs.view.Viewport", {
	...
	requires: ["Docs.view.search.Container", "Docs.view.Header", "Docs.view.Tabs", "Docs.view.TreeContainer", "Docs.view.welcome.Index", "Docs.view.cls.Index", "Docs.view.cls.Container", "Docs.view.casass.Index", "Docs.view.casass.Container", "Docs.view.shopmng.Index", "Docs.view.shopmng.Container", "Docs.view.erpcrm.Index", "Docs.view.erpcrm.Container"],
	id: "viewport",
	layout: "border",
	defaults: {
		xtype: "container"
			...
			items: [{
				...
				items: {
					...
					items: [{
						...
						xtype: "casasscontainer",
						id: "casass"
					}, {
						xtype: "shopmngindex",
						id: "shopmngindex"
					}, {
						xtype: "shopmngcontainer",
						id: "shopmng"
					}, {
						xtype: "erpcrmindex",
						id: "erpcrmindex"
					}, {
						xtype: "erpcrmcontainer",
						id: "erpcrm"
					}]
				}
			}]
...
Ext.define("Docs.Application", {
	requires: ["Ext.app.Application", "Docs.History", "Docs.Settings", "Docs.view.Viewport", "Docs.controller.Welcome", "Docs.controller.Failure", "Docs.controller.Classes", "Docs.controller.Search", "Docs.controller.InlineCasass", "Docs.controller.Casass", "Docs.controller.InlineShopmng", "Docs.controller.Shopmng", "Docs.controller.InlineErpcrm", "Docs.controller.Erpcrm", "Docs.controller.Tabs"],
	constructor: function() {
		this.createApp();
	},
	createApp: function() {
		new Ext.app.Application({
			name: "Docs",
			controllers: ["Welcome", "Failure", "Classes", "Search", "InlineCasass", "Casass", "InlineShopmng", "Shopmng", "InlineErpcrm", "Erpcrm", "Tabs"],
			launch: this.launch
		})
	},
	launch: function() {
