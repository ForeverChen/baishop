...
Ext.onReady(function() {
	...
	//业务请求的URL
    Url = {
    	getRoles: '${page_context}/admin/SysRoles.jspx?func=getRoles',
    	delRoles: '${page_context}/admin/SysRoles.jspx?func=delRoles',
    	saveRoles: '${page_context}/admin/SysRoles.jspx?func=saveRoles',
      	upRoles: '${page_context}/admin/SysRoles.jspx?func=upRoles',
   		downRoles: '${page_context}/admin/SysRoles.jspx?func=downRoles',
   		getUsersByRoles: '${page_context}/admin/SysRoles.jspx?func=getUsersByRoles',   				
    	getModulesByRoles: '${page_context}/admin/SysModules.jspx?func=getModules&action=SysRoles'
    };
	...
	function saveRoles(win, frm, tree){
		...
		frm.submit({
		    ...
		    success: function(form, action) {
		    	...
		    	if((win.id=="winRoles" && !Ext.getCmp("hddRoleId").getValue()) || (win.id=="winGroup" && !Ext.getCmp("group_hddRoleId").getValue())) {
		    		//添加
		    		...
		    		//编辑
		    		node.set('roleName', action.result.role.roleName);
		    		node.set('roleDesc', action.result.role.roleDesc);
		    		node.set('roleType', action.result.role.roleType);
