...
Ext.onReady(function(){
    ...
    //业务请求的URL
    Url = {
    	getSellingGoodsList: '${page_context}/goods/GoodsManager.jspx?func=getGoodsList&isDelete=0&isOnSale=1',
    	getStorageGoodsList: '${page_context}/goods/GoodsManager.jspx?func=getGoodsList&isDelete=0&isOnSale=0',
    	getDeletedGoodsList: '${page_context}/goods/GoodsManager.jspx?func=getGoodsList&isDelete=1',
    	delGoods: '${page_context}/goods/GoodsManager.jspx?func=delGoods',
    	delRealGoods: '${page_context}/goods/GoodsManager.jspx?func=delRealGoods',
    	recoveryGoods: '${page_context}/goods/GoodsManager.jspx?func=recoveryGoods',
    	upShelfGoods: '${page_context}/goods/GoodsManager.jspx?func=upShelfGoods',
    	offShelfGoods: '${page_context}/goods/GoodsManager.jspx?func=offShelfGoods',
    	modifyPrice: '${page_context}/goods/GoodsManager.jspx?func=modifyPrice',
    	modifyInventory: '${page_context}/goods/GoodsManager.jspx?func=modifyInventory',
    	clearDeledGoods: '${page_context}/goods/GoodsManager.jspx?func=clearDeledGoods'
    };
    ...
    var gridSelling = Ext.create('Ext.grid.Panel', {
        ...
        columns:[{
            ...
            renderer: function(value, p, record) {
				return Ext.String.format(
					'<a href="/goods.html?id={0}" target="_blank" title="{1}">'+
            ...
            renderer: function(value, p, record) {
				return Ext.String.format(
					'<a href="/goods.html?id={0}" target="_blank" title="{1}">{1}</a>',
					record.data.goodsId,
					value
				);
			}
        ...
        tbar: [{
		    ...
		    handler: function(btn, event) {
		    	window.location.href = "GoodsPublish.jspx";
		    }
        },'-',{
            text: '下架',
            iconCls: 'icon-cls',
		    ...
		    handler: function(btn, event) {
		    	...
		    	if (rows.length > 0) {
		    		window.location.href = "GoodsPublish.jspx?action=edit&goodsId="+ rows[0].get('goodsId');
		    	} else {
